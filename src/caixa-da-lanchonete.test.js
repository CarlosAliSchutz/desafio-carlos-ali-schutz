...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ['chantily sem cafe', 'dinheiro', 'Item extra não pode ser pedido sem o principal', ['chantily,1', 'cafe,0']],
        ['chantily sem cafe', 'credito', 'Item extra não pode ser pedido sem o principal', ['chantily,1', 'cafe,0']],
        ['chantily sem cafe', 'debito', 'Item extra não pode ser pedido sem o principal', ['chantily,1', 'cafe,0']],
        ['com quantidade zero', 'debito', 'Item extra não pode ser pedido sem o principal', ['chantily,1', 'cafe,0']],
        ['com forma de pagamento inválida', 'dinheiro falso', 'Forma de pagamento inválida!', ['cafe, 1']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));

    test.each([
        ['com um valor', 'credito', 'Item inválido!', ['1,1']],
        ['item inexistente', 'credito', 'Item inválido!', ['uva, 10']],
        ['cafe', 'dinheiro', 'R$ 2,85', ['cafe,1', 'chantily,0']],
        ['sanduiche', 'dinheiro', 'R$ 6,17', ['sanduiche,1', 'chantily,0']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
});
